...
func listYouTubePublishSlotsPostgres(ctx *config.AppContext, channel string) ([]*types.YouTubePublishSlot, error) {
...
func replaceYouTubePublishSlotsPostgres(ctx *config.AppContext, channel string, slots []*types.YouTubePublishSlot) error {
	if err := ensureYouTubePublishSlotsPostgres(ctx); err != nil {
		return err
	}
