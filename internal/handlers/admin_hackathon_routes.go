...
func registerConferenceHackathonAdminRoutes(r *mux.Router, app *config.AppContext) {
	...
	register("/projects/{projectID}/members", HackathonAdminAddProjectMember, http.MethodPost)
	...
	register("/awards/proposals/review", HackathonAdminReviewSponsorAwardProposal, http.MethodPost)
